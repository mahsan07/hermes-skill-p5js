...
P5Js is a focused, shareable agent workflow.

## What it does

Build generative art, shaders, interactive sketches, and 3D scenes with p5.js. Use when the user explicitly requests this capability or a closely related task.
